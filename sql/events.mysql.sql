...
CREATE TABLE events (
    ...
    moderated_by_user_login VARCHAR(32) NULL COMMENT 'Who validated/rejected the event',
    moderated_on_datetime_utc DATETIME NULL COMMENT 'When was the event validated/rejected',
...
INSERT INTO metadata (keyword, value) VALUES ('events_custo_version', '1.0.1.0');
